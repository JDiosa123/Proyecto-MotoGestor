        ...
        <div class="max-w-3xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-xl sm:rounded-lg">
                ...
                <div class="p-6 bg-gray-700 text-white font-semibold text-lg sm:rounded-t-lg">
                    <h4>{{ __('Formulario de Registro de Moto') }}</h4>
                </div>

                {{-- Cuerpo del Formulario --}}
                <div class="p-6">
                    <form method="POST" action="{{ route('admin.motos.store') }}" class="space-y-6">
                        @csrf

                        <div>
                            <x-input-label for="placa" :value="__('Placa')" />
                            <x-text-input id="placa" oninput="this.value = this.value.toUpperCase()" 
                                maxlength="6" class="block mt-1 w-full" type="text" name="placa" :value="old('placa')" required />
                        ...
                        <div>
                            ...
                            <x-text-input id="cilindraje" class="block mt-1 w-full"
                                type="number" name="cilindraje" :value="old('cilindraje')" required />
                        ...
                        <div>
                            ...
                            <x-text-input id="color" class="block mt-1 w-full"
                                type="text" name="color" :value="old('color')" required />
                        ...
                        <div>
                            ...
                            {{-- Nota: Se asume que la clase 'border-gray-300 rounded-md' incluye estilos dark-mode, 
                                o que el componente de selección requiere estilos adicionales para consistencia. 
                                Lo mantengo como estaba ya que Select no es un componente personalizado. --}}
